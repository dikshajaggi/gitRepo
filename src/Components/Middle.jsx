...
function Middle() {
  return (
        ...
        <div className="rows">
          <div className="row0">
            ...
            <div className="box1" style={{backgroundColor:"#2E9CFD"}}>
              ...
              <div className="body2">
                  <div className="body1" style={{color:"#ffffff",fontSize:"12px"}}><h1>4658</h1><CallMadeIcon style={{color:"#ffffff",fontSize:"12px"}}></CallMadeIcon> +3.59%</div>
                  <CircularProgress variant="determinate" value={75}></CircularProgress>
              </div>
            </div>
            </div>
    ...
    <div className="col2">
      <div className="row4">
        <div className="box1">
              <span className="head1">Total Applications <MoreHorizIcon style={{fontSize:"18px"}}></MoreHorizIcon></span>
              <div className="body2">
                  <div className="body1" style={{color:"#F05E73", fontSize:"12px"}}><h1>1501</h1><CallReceivedIcon style={{color:"#F05E73",fontSize:"12px"}}></CallReceivedIcon> -0.4%</div>
                  <CircularProgress variant="determinate" value={75}></CircularProgress>
              </div>
        </div>
      </div>
    ...
    <div className="col3">
      ...
      <img src="./images/Capture.PNG" style={{marginLeft:"94px" , height:"100px", position:"absolute"}}></img>
      <div className="col3part2">
        ...
        <div className="p2">
          <div className="p3"><Info></Info></div>
          <div className="p3"><Info></Info></div>
          <div className="p3"><Info></Info></div>
          <div className="p3"><Info></Info></div>
          <div className="p3"><Info></Info></div>
